...
void LocalNet::initGridBoxes(db::Database const& database) {
...
void LocalNet::initNumOfVertices(db::Database const& database) {
...
bool LocalNet::checkPin(db::Database const& database) const {
...
double LocalNet::getWireSegmentPenalty(db::Database const& database, int guideIdx, int trackIdx, int cpIdx1, int cpIdx2) const {
